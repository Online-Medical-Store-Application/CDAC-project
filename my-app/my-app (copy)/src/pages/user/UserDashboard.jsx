                ...
                return (
                  <div key={orderIndex} className="mb-4 border border-secondary rounded bg-light p-3">
                    {order.cartItems.map((item, itemIndex) => {
                      ...
                      const { status } = order;
                      return (
                        <div key={itemIndex} className="d-flex flex-column flex-md-row mb-4 border border-secondary rounded bg-light">
                          {/* Left Column */}
                          <div className="p-3 border-end">
                            <div className="row">
                              ...
                              <div className="col-6 mb-2">
                                ...
                                <div className={`text-muted ${status === "pending" ? "text-danger" : "text-success"}`}>{status}</div>
                              </div>
                            </div>
                          </div>
                          {/* Right Column */}
                            ...
                            <ul className="list-unstyled">
                              <li className="d-flex justify-content-between align-items-start py-3">
                                <div className="d-flex">
                                  <img className="img-fluid me-3 rounded border" src={productImageUrl} alt="Product" style={{ maxHeight: "150px", objectFit: "contain" }} />
                                  <div>
