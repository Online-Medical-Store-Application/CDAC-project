                ...
                {order.cartItems.map((item, index) => {
                  ...
                  return (
                    <tr key={index}>
                      ...
                      <td>{id}</td>
                      <td>
                        <img src={productImageUrl} alt="Product" className="img-fluid" style={{ maxWidth: "100px", height: "auto" }} />
                      </td>
                      <td>{title}</td>
                      <td>{category}</td>
                      ...
                      <td onClick={() => orderDelete(order.id)} className="text-danger cursor-pointer">
                        Delete
                      </td>
                    </tr>
                  );
